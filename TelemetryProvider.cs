...
namespace SimFeedback.telemetry
{
    public sealed class TelemetryProvider : AbstractTelemetryProvider
    {
        ...
        private const int PortNum = 26999;
        ...
        public TelemetryProvider()
        {
            ...
            BannerImage = @"img\banner_generalptp.png";
            IconImage = @"img\icon_generalptp.png";
            TelemetryUpdateFrequency = 60;
        }

        public override string Name => "generalptp";

        public override void Init(ILogger logger)
        {
            base.Init(logger);
            Log("Initializing General Purpose Telemetry Provider");
        ...
        public override void Stop()
        {
            ...
            LogDebug("Stopping General Purpose Telemetry Provider");
            _isStopped = true;
            if (_t != null) _t.Join();
        }
        ...
        public override void Start()
        {
            if (_isStopped)
            {
                LogDebug("Starting General Purpose Telemetry Provider");
                _isStopped = false;
                _t = new Thread(Run);
                _t.Start();
            }
